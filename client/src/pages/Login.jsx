      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === "Sign up" && !isDataSubmitted && (
          <>
            ...
            <input onChange={(e) => setEmail(e.target.value)} value={email} type="email" className='p-2 border border-gray-500 rounded-md focus:outline-none' placeholder="Email Address" required/>
        ...
        {/* ✅ REMOVED: duplicate block with typo currState==="sign up" (lowercase) was here — caused input conflicts */}
